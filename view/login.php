...
<link href="<?=$base_url?>/assets/bootstrap/dist/js/bootstrap.min.js" rel="stylesheet">
<!-- Font Awesome -->
...
<input class="form-check-input" type="checkbox" name="rm" value="rm" id="flexCheckIndeterminate">
...
<br />
<div>
<h1><i class="fa fa-cash-register"></i>&ensp; Kasir Web</h1>
</div>
</div>
</form>
</section>
