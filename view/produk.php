<?php include 'header.php' ?><title>Kasir - Daftar Produk</title>
...
} elseif ($_GET['hapus'] == 'gagal') {echo '<div class="alert alert-danger" role="alert">
Hapus Produk Gagal </div>';}}if (isset($_GET['update'])) {if ($_GET['update'] == 'berhasil') {
echo '<div class="alert alert-success" role="alert">Edit Produk Berhasil</div>';
} elseif ($_GET['update'] == 'gagal') {echo '<div class="alert alert-danger" role="alert">
Edit Produk Gagal </div>';}}if (isset($_GET['info']) && $_GET['name']) {
if ($_GET['info'] == 'duplicate'){echo '<div class="alert alert-danger" role="alert">
Produk Dengan Nama <b>"' . $_GET['name'] . '"</b> Sudah Ada / Sudah Ditambahkan</div>';}}?>
<div class="container body"><div class="main_container"><div class="col-md-3 left_col menu_fixed">
...
<h3>Data Produk</h3></div><div class="title_right"><div class="col-md-5 col-sm-5 form-group pull-right top_search">
</div></div></div><div class="clearfix"></div><div class="row"><div class="col-md-12 col-sm-12 "><div class="x_panel">
<div class="x_title"><a class="btn btn-primary ml-3" href="<?= $base_url ?>/view/tambah_produk">Tambah Produk</a>
