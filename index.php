...
<title>Kasir - Beranda</title><style type="text/css"> sm{ margin-top: 10px; padding-top: 10px;
font-size : 0.5em;} h2{ font-size: 1.5em;} </style><?php
$jmlhtrsk = 0;
...
</a></div><div class="col-md-3 col-sm-4  tile_stats_count">
<a href="<?=$base_url?>/view/riwayat_penjualan">
<span class="count_top"><i class="fa fa-clock-o"></i> Transaksi Hari Ini</span>
<div class="count"><?php if($jmlhtrsk==0){echo '<div class="count">'.$jmlhtrsk.'</div>';}else{echo '<div class="count green">'.$jmlhtrsk.'</div>';}?>
</div><span class="count_bottom">Transaksi</span></a></div><div class="col-md-3 col-sm-4  tile_stats_count">
...
<span class="count_bottom"> Produk Hampir Habis</span></div></div></div>
<!-- /top tiles -->
<div class="row"><div class="col-md-12 col-sm-12  "><div class="x_panel"><div class="x_title">
<h2>Pofil Toko</h2><ul class="nav navbar-right panel_toolbox">
