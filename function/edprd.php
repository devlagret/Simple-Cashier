        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?=$base_url?>/index.php" class="site_title"><i class="fa fa-paw"></i> <span>Gentelella Alela!</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
								<li><a  href="<?=$base_url?>/index.php"><i class="fa fa-home"></i> Home</span></a>	</li>
                  <li><a href="<?=$base_url?>/view/kasir.php"><i class="fa fa-barcode"></i> Kasir </span></a></li>
                  <li><a><i class="fa fa-archive"></i> Produk <span class="fa fa-chevron-down"></a>
                  <ul class="nav child_menu">
                    <li><a href="<?=$base_url?>/view/tambah_produk.php">Tambah Produk</a></li>
                    <li><a href="<?=$base_url?>/view/produk.php">Daftar Produk</a></li>
                    </ul>
                </li>
                ...
                <ul class=" navbar-right">
                  <li class="nav-item dropdown open" style="padding-left: 15px;">
                    <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                      <img src="<?=$img_profile_path?>" alt="">John Doe
                    </a>
          ...
          <div class="">
            ...
            <div class="row">
							<div class="col-md-12 col-sm-12 ">
								<div class="x_panel">
									<div class="x_title">
									<a class="btn btn-primary ml-3" href="<?=$base_url?>/view/tambah_produk.php">Daftar Produk Produk</a>
